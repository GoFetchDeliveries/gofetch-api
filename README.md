...
2. Retrieve your production authentication token with [create a session](sessions.md#create) or [sign in](v1/users.md) request. Store your authentication token securely and use it for all other API requests.

3. Check that your authentication works with a [hello world](hello_world.md) request.
